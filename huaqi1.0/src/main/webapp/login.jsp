...
<!--登录框-->
<div style="width:30%; margin-top:50px; margin-bottom: 50px" id="login_modal" class="panel panel-primary center-block">
    ...
    <form class="form-horizontal">
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <input type="text" name="id" class="form-control" id="login_id_input" placeholder="Id" style="width:80%">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <input type="password" name="password" class="form-control" id="login_password_input" placeholder="Password" style="width:80%">
                <span class="help-block"></span>
            </div>
        </div>
    </form>
    <div class="modal-footer">
        <button type="button" class="btn btn-success" id="login_btn">登录</button>
        <!--<button type="button" class="btn btn-primary" id="login_register_btn">注册</button>-->
        <a type="button" class="btn btn-primary "id="login_register_btn" href="registerPage">注册</a>
    </div>
</div>
<!--登录框-->
