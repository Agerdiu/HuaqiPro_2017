...
<div id="zxbd" class="center">
    ...
    <form class="form-horizontal" method="post" action="">
        ...
        <div class="formword">
            <label>确认身份信息</label>
            <label><input type="checkbox" value="businessman" name="userType">工商业人员</label>
        </div>
        <div class="formword">
        ...
        <div class="formword">
            <label>9.一个月缴纳税额为多少</label>
            <select id="monthRatal" name="monthRatal">
                <option name="monthRatal" value="" selected>请选择</option>
                <option name="monthRatal" value="-1">不纳税</option>
                <option name="monthRatal" value="-0.7">900元-1800元（含）</option>
                <option name="monthRatal" value="-0.45">1800元-3000元（含）</option>
                <option name="monthRatal" value="-0.25">3000元-4500元（含）</option>
                <option name="monthRatal" value="-0.1">4500元-6000元（含）</option>
                <option name="monthRatal" value="0">6000元以上</option>
            </select>
        </div>
        <div class="formword">
            <label> 10.可抵押的厂房、设备、超市等的价值？</label>
            <select id="commerceHypothecaryValue" name="commerceHypothecaryValue">
                <option  name="commerceHypothecaryValue" value="" selected>请选择</option>
                <option name="commerceHypothecaryValue" value="-1">暂无厂房设备等</option>
                <option  name="commerceHypothecaryValue" value="-0.7">30万以下</option>
                <option name="commerceHypothecaryValue" value="-0.45">30万（含）至60万</option>
                <option name="commerceHypothecaryValue" value="-0.25">60万（含）至100万</option>
                <option name="commerceHypothecaryValue" value="-0.1">100万（含）以上</option>
            </select>
        </div>

        <div class="formword">
            <label>11.现有负债额度（银行贷款） </label>
        ...
        <div class="formword">
            <label> 19.愿意每年自己花钱去体检吗？</label><br>
        ...
        <div class="formword">
            <label>20.身边人向除了银行以外的地方借款利息是多少</label>
        ...
        <div class="formword">
            <label> 30.你们村离主干道（国道、省道）有多远？</label>
