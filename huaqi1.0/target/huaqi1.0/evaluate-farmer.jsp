...
<div id="zxbd" class="ques_list">
    ...
    <form name="formFormer" class="form-horizontal center" method="post" action="">
        ...
        <div class="formword">
            <label> 9.整个家庭的年收入（万）大概为÷家庭人口数</label>
            <select id="aveIncome" name="aveIncome">
                <option name="aveIncome" value="" selected>请选择</option>
                <option name="aveIncome" value="-1">≤1</option>
                <option name="aveIncome" value="-0.8">1~3（含）</option>
                <option name="aveIncome" value="-0.45">3~5（含）</option>
                <option name="aveIncome" value="0">≥5</option>
            </select>
        </div>
        <div class="formword">
        ...
        <div class="formword">
            <label>34.是否使用了现代农业技术（比如大棚种植、生态农业等） </label>
            <label><input name="modernAgriTech" value="0" type="radio" >是</label>
            <label><input name="modernAgriTech" value="-1" type="radio" >否</label>
        </div>
        <div class="formword">
        ...
        <div class="formword">
            <label>36.五年内发生自然灾害数 </label>
            <select id="disasterNumber" name="disasterNumber">
                <option  name="disasterNumber" value="" selected>请选择</option>
                <option name="disasterNumber" value="0">0次</option>
                <option name="disasterNumber" value="-0.1">1次</option>
                <option name="disasterNumber" value="-0.25">2次</option>
                <option name="disasterNumber" value="-0.45">3次</option>
                <option name="disasterNumber" value="-0.6">4次</option>
                <option name="disasterNumber" value="-1">5次以及以上</option>
            </select>
        </div>
        <div class="formword">
            <label>37.自然灾害灾损率 </label>
            <select id="damageRate" name="damageRate">
                <option name="damageRate" value="" selected>请选择</option>
                <option name="damageRate" value="-1">巨灾（A级）灾损率指数>0.5</option>
                <option name="damageRate" value="-0.6">大灾（B级）灾损率指数0.4~0.5</option>
                <option name="damageRate" value="-0.3">中灾（C级）灾损率指数0.3~0.4</option>
                <option name="damageRate" value="-0.1">小灾（D级）灾损率指数0.2~0.3</option>
                <option name="damageRate" value="0">微灾（E级）灾损率指数＜0.2</option>
